...
type alias FieldsComponent a e = Entities -> Form e a -> Html (Msg a)

type alias ListField a = a -> Html (Msg a)
...
init : Title -> List ( String, Field.Field ) -> ListFields a -> (a -> List ( String, Field.Field )) -> Validation e a -> FieldsComponent a e -> (Entities -> Dict ID a) -> Model a e 
init title initialFields listFields setFormFields validation fields entityAccessor = 
  { title = title
